		...
		<block v-if="htmlReset==0">
				...
				<view class="fuwu_box">
					...
					<view class="fuwu_list">
						...
						<view class="fuwu_li" @tap="jump" data-url="/pagesA/my_zc/my_zc?type=about" :data-login='false' :data-haslogin='hasLogin'>
						...
						<view class="fuwu_li" @tap="jump" data-url="/pagesA/my_cyzc/my_cyzc?type=about" :data-login='false' :data-haslogin='hasLogin'>
